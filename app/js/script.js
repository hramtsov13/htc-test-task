...
function showUser(argument) {
  ...
  buttonLogout.classList.remove("button__hidden");
  btn.classList.add("button__hidden");
}
...
buttonLogout.addEventListener("click", function () {
  ...
  buttonLogout.classList.add("button__hidden");
  btn.classList.remove("button__hidden");
});

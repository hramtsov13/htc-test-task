...
var checkBtn = document.getElementById("login-check");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var userLoginSession = sessionStorage.getItem("user");
  var currentUser = userLogin || userLoginSession;
